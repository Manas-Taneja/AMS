  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden bg-transparent h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        className="bg-card text-foreground rounded-full shadow-xl border border-border px-4 py-2 font-medium"
        arrowClassName="fill-card bg-card"
        {...tooltip}
      />
    </Tooltip>
  )
