...
export const BillCard: React.FC<BillCardProps> = ({ bill, onView: _onView, onApprove: _onApprove, onDelete: _onDelete, onEdit: _onEdit, canApprove: _canApprove, canEdit: _canEdit, canDelete: _canDelete }) => (
  <Card>
